...
func (p InfrastructurePriceProvider) GetPriceFor(ctx context.Context, ref corev1.ObjectReference) (float64, bool, error) {
	switch ref.Kind {
	case kubemark.InfrastructureRefKind:
		return kubemark.GetPriceFor(ctx, p.client, ref)
	}
