...
var (
	...
	projectImage = "example.com/cluster-api-machine-price-operator:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting cluster-api-machine-price-operator integration test suite\n")
